...
public class VersionManagementUtil {
    ...
    public static int VersionComparison(String versionServer, String versionLocal) {  
        ...
        while (index1 < version1.length() && index2 < version2.length()) {  
            ...
            MyApp.MLog(TAG," ===== number1 ====" + Arrays.toString(number1));  
            int[] number2 = getValue(version2, index2);  
                MyApp.MLog(TAG," ===== number2 ====" + Arrays.toString(number2));  
  
            if (number1[0] < number2[0]){  
                    MyApp.MLog(TAG," ===== number1[0] ====" + number1[0]);  
                MyApp.MLog(TAG," ===== number2[0] ====" + number2[0]);  
                return -1;  
            }  
